...
def threshold_Scurve_run_init():
  ...
  declare_param("inputDAC","inputDAC","1");
  declare_param("threshold","threshold","156")
  
def threshold_Scurve_run_run(run_name,acq_time,mode,inputDAC,threshold):
  print OKGREEN + " =================================================" +ENDC
  print OKGREEN + "        ===================================" +ENDC
  print OKGREEN + "               S-curve run " +ENDC
  print OKGREEN + "        ===================================" +ENDC
  print OKGREEN + " =================================================" +ENDC
  ...
  for dif in range_dif:
    for ichip in range(NCHIP):   #initialize
  ...
  run_name0="%s_inputDAC%d_trigger%d"%(run_name,int(inputDAC),int(threshold))
...
def threshold_Scurve_run_get_progress():
    return progress_acq
