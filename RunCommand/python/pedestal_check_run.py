...
def pedestal_check_run_init():
  ...
  declare_param("pe","pe","1")
  
def pedestal_check_run_run(run_name,acq_time,mode,pe):
  print OKGREEN + " =================================================" +ENDC
  print OKGREEN + "        ===================================" +ENDC
  ...
  CALIB_CARD="/home/data/calibration/calib_20170906/calibration_card.xml"
  ...
  run_name0="%s_pe%d"%(run_name,int(pe))
...
def pedestal_check_run_get_progress():
    return progress_acq
...
def AnaHistSummary(xmlfile):
  cmd="%s/bin/wgAnaPedestal -rf %s"%(ANA_DIR,xmlfile)
  subprocess.call( cmd , shell=True)
  return
